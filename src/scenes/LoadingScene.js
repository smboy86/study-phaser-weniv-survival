...
import beamOgg from '../assets/sounds/beam.mp3';
import scratchOgg from '../assets/sounds/scratch.mp3';
import hitMobOgg from '../assets/sounds/hitMob.mp3';
import growlOgg from '../assets/sounds/growl.mp3';
import explosionOgg from '../assets/sounds/explosion.mp3';
import hurtOgg from '../assets/sounds/hurt.mp3';
import expUpOgg from '../assets/sounds/expUp.mp3';
import nextLevelOgg from '../assets/sounds/nextLevel.mp3';
import gameOverOgg from '../assets/sounds/gameover.mp3';
import gameClearOgg from '../assets/sounds/gameClear.mp3';
import pauseInOgg from '../assets/sounds/pauseIn.mp3';
import pauseOutOgg from '../assets/sounds/pauseOut.mp3';
